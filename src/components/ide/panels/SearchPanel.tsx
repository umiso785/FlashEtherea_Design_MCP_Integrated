          ...
          <div className="space-y-2">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-900 rounded p-2">
                <div className="flex items-center gap-2 mb-2">
                  <FileText className="w-4 h-4 text-blue-400" />
                  <span className="text-sm text-gray-300">src/components/Editor.tsx</span>
                  <span className="text-xs text-gray-500">1 match</span>
                </div>
                <div className="space-y-1 ml-6">
                  <div className="text-xs text-gray-400 hover:bg-gray-700 p-1 rounded cursor-pointer">
                    Line 42: console.log('<span className="bg-yellow-400 text-black px-1">{searchTerm}</span>');
                  </div>
                </div>
              </div>
            </div>
