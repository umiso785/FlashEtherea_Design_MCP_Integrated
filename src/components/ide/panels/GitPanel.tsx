...
export default function GitPanel() {
  const changes = [
    ...
    { file: 'src/components/ide/ActivityBar.tsx', type: 'added', additions: 45, deletions: 0 },
    { file: 'src/layouts/IDELayout.tsx', type: 'added', additions: 78, deletions: 0 },
    ...
    <div className="h-full bg-gray-800 text-white flex flex-col">
      <div className="p-3 border-b border-gray-700">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-300 mb-3">
          ...
          <span className="text-green-400">4 changes</span>
        </div>
